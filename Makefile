...
OBJECTS += mbed-os/features/nanostack/nanostack-interface/NanostackInterface.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1527361163.94
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1527361163.94
